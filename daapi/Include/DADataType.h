...
typedef char						TDAJsonStringType[DA_STR_JSON_SIZE];
...
// HKEX stock Order type:
	// 定单类型：
	//		STOCK_HKEX_AUCTION_LIMIT_ORDER=竞价限价盘
	//		STOCK_HKEX_AUCTION_ORDER_SELL_ONLY=竞价盘
	//      STOCK_HKEX_ENHACE_LIMIT_ORDER=增强限价盘
	// Order type:
	//		STOCK_HKEX_AUCTION_LIMIT_ORDER=AL:Auction limit order
	//      STOCK_HKEX_AUCTION_ORDER_SELL_ONLY=AO: Auction 0rder(Se11 only)
	//		STOCK_HKEX_ENHACE_LIMIT_ORDER=EL:Enhace limit order

#define STOCK_HKEX_AUCTION_LIMIT_ORDER		"5"
#define STOCK_HKEX_AUCTION_ORDER_SELL_ONLY	"6"
#define STOCK_HKEX_ENHACE_LIMIT_ORDER		"7"
